...
dotnet nuget push -s https://buildtools.ogsofttech.com:8079/v3/index.json ".\Publish\OGA.SharedKernel.1.3.1.nupkg"
dotnet nuget push -s https://buildtools.ogsofttech.com:8079/v3/index.json ".\Publish\OGA.SharedKernel.1.3.1.snupkg"
